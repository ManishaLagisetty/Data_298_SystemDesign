...
const AboutUs = () => (
  <div className="about-us" style={{ backgroundImage: `url(${background})` }}>
    <div className="about-content">
      ...
      <p>
        Our approach is not just about deploying technology but about fostering partnerships that create lasting impacts. Together, we aim to set a new standard in transport management, one that
        prioritizes efficiency, sustainability, and user experience.
      </p>
      <p>
        Join us in building the future of transportation and a more sustainable world.
      </p>
      <div className="team-list">
        <h4>Meet Our Team</h4>
        <ul>
          <li>Damini Prashant Vichare, Manisha Lagisetty, Sweekruthi Balivada, Yuting Sha</li>
